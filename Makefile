...
sent: build
	...
	cabal v2-run msg-tax -- -s "Высокооплачиваемая работа для девушек в Тюмень, Ханты-Мансийск, Сургут и города ХМАО, ЯНАО. Прямой работодатель. Работы много. Мы ищем не сотрудницу, а партнёра, которому можно доверять. Отдадим предпочтение: 1) Aмбициозной профессионалке, готовой получать удовольствие от работы. 2) Двум подружкам без вредных привычек, для работы в паре - вдвоём на апартаментах. 3) Девушкам с регионов, готовых работать с проживанием вахтовым методом от 10 дней вахта! За 10 дней Вы сможете заработать 200 000 руб!!! У Нас очень простые и понятные условия работы: Мы работаем с Вами 50/50. Если у тебя есть доп. услуги- это твои деньги. Расчёт каждый час!!! Фотогроаф и фотосеесии для нас не проблема!!! График работы подстраивается под Вас. -Никаких штрафов и вычетов - ИСКЛЮЧЕНО. -Обширная база постоянный клиентов - только граждане РФ. -Безопасность обеспечена на все 100%. -Апартаменты предоставляются."
